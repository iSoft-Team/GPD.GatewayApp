...
namespace SyngentaGatewayApp.DeserializedClass
{
    ...
    public class LineMasterPayLoad
    {
        ...
        public int createdBy { get; set; }
        public int updatedby { get; set; }
        public List<LineDetailsCollection> lineDetailsCollection { get; set; }
        public string createdDate { get; set; }
        public string updatedDate { get; set; }
        public int isActive { get; set; }
    ...
    public class RePayLoad
    {
        ...
        public int isactive { get; set; }
        public int updatedBy { get; set; }
        public List<BatchLevelCollection> batchLevelCollection { get; set; }
        public int productId { get; set; }
        public string createdDate { get; set; }
        public string updatedDate { get; set; }
        public LineMaster lineMaster { get; set; }
